...
return (new CustomEvent(event_name,(function (){var obj14059 = {"detail":data};
return obj14059;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__6802__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__6802__auto__)){
var and__6802__auto____$1 = (window["CustomEvent"]);
...
var args14064 = [];
var len__7923__auto___14070 = arguments.length;
var i__7924__auto___14071 = (0);
while(true){
if((i__7924__auto___14071 < len__7923__auto___14070)){
args14064.push((arguments[i__7924__auto___14071]));

var G__14072 = (i__7924__auto___14071 + (1));
i__7924__auto___14071 = G__14072;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args14064.length)].join('')));
...
var f = (function (){var pred__14067 = cljs.core._EQ_;
var expr__14068 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__14067.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__14068))){
return ((function (pred__14067,expr__14068){
return (function (p1__14060_SHARP_){
return console.warn(p1__14060_SHARP_);
});
;})(pred__14067,expr__14068))
} else {
if(cljs.core.truth_(pred__14067.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__14068))){
return ((function (pred__14067,expr__14068){
return (function (p1__14061_SHARP_){
return console.debug(p1__14061_SHARP_);
});
;})(pred__14067,expr__14068))
} else {
if(cljs.core.truth_(pred__14067.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__14068))){
return ((function (pred__14067,expr__14068){
return (function (p1__14062_SHARP_){
return console.error(p1__14062_SHARP_);
});
;})(pred__14067,expr__14068))
} else {
return ((function (pred__14067,expr__14068){
return (function (p1__14063_SHARP_){
return console.log(p1__14063_SHARP_);
});
;})(pred__14067,expr__14068))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__14074){
var map__14077 = p__14074;
...
var eval_fn = cljs.core.get.call(null,map__14077__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__14079_SHARP_);
});})(new_def))
);
...
return (function (p__14080){
var vec__14081 = p__14080;
var ky = cljs.core.nth.call(null,vec__14081,(0),null);
...
var args14084 = [];
var len__7923__auto___14087 = arguments.length;
var i__7924__auto___14088 = (0);
while(true){
if((i__7924__auto___14088 < len__7923__auto___14087)){
args14084.push((arguments[i__7924__auto___14088]));

var G__14089 = (i__7924__auto___14088 + (1));
i__7924__auto___14088 = G__14089;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args14084.length)].join('')));
...
if(cljs.core.truth_((function (){var and__6802__auto__ = typeof localStorage !== 'undefined';
